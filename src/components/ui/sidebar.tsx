...
const SidebarMenuItem = React.forwardRef<HTMLLIElement, React.ComponentProps<"li">>(({
  className,
  ...props
}, ref) => <li ref={ref} data-sidebar="menu-item" className={cn("group/menu-item relative mx-0 font-extralight font-sans text-lg bg-white/0 text-primary", className)} {...props} />);
