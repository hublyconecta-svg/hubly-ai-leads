...
const SidebarContent = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(({
  ...
  return <div ref={ref} data-sidebar="content" className={cn("min-h-0 flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden flex items-start justify-start", className)} {...props} />;
});
...
const SidebarMenuItem = React.forwardRef<HTMLLIElement, React.ComponentProps<"li">>(({
  className,
  ...props
}, ref) => <li ref={ref} data-sidebar="menu-item" className={cn("group/menu-item relative mx-0 font-extralight font-sans text-lg bg-white/0 text-destructive-foreground", className)} {...props} />);
